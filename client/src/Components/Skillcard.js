    ...
    return (
        <div className="skillCard flex justify-center">
            <div className="flex flex-row border border-1 rounded-lg items-center w-[40rem] bg-slate-100 hover:bg-gray-100 hover:outline-offset-8" id={"card"+props.id}>
                <p id={"skill"+props.id} className="px-4 py-3 justify-items-start">{props.skill}</p>
                <p id={"skillLevel"+props.id} className="px-4 py-3 justify-items-start" contentEditable="false">{props.skillLevel}</p>
                <p id={"yearsOfExperience"+props.id} className="px-4 py-3 justify-items-start" contentEditable="false">{props.yearsOfExperience}</p>
